...
const FEATURES = [
  [
    FileText,
    "Markdown",
    "Write in markdown, see it live with instant preview.",
  ],
  [Save, "Auto-Save", "Every change saved instantly — never lose a thought."],
  [Moon, "Dark Mode", "Easy on the eyes, day or night. Flips with one click."],
  [
    CheckSquare,
    "Task Lists",
    "Checkboxes in your notes. Track todos across notebooks.",
  ],
  [
    Search,
    "Full-Text Search",
    "Find any note instantly — title, content, and more.",
  ],
  [
    BarChart3,
    "Activity Dashboard",
    "See your writing streaks, stats, and notebook activity.",
  ],
] as const;
      ...
      <section id="features" className="max-w-4xl mx-auto px-6 pb-24">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {FEATURES.map(([Icon, title, desc]) => (
            <div
              key={title}
              className="text-center p-4 rounded-xl border hover:shadow-sm transition-shadow"
            >
              <Icon
                className="size-7 mx-auto mb-3 text-amber-500"
                strokeWidth={1.5}
              />
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          <div className="rounded-xl border p-6 space-y-3">
            <p className="text-sm text-muted-foreground leading-relaxed italic">
              &ldquo;Finally a note-taking app that stays out of my way. No
              folders, no tags, just me and my thoughts.&rdquo;
            </p>
            <div>
